...
[assembly: ExportEffect(typeof(MovingImages.Droid.TouchEffect), "TouchEffect")]

namespace MovingImages.Droid
{
    public class TouchEffect : PlatformEffect
    {
        Android.Views.View view;
        Element formsElement;
        MovingImages.TouchEffect pclTouchEffect;
        bool capture;
        ...
        protected override void OnAttached()
        {
            ...
            MovingImages.TouchEffect touchEffect =
                (MovingImages.TouchEffect)Element.Effects.
                    FirstOrDefault(e => e is MovingImages.TouchEffect);
